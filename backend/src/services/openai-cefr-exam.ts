  ...
  for (const sec of sections) {
    ...
    for (let i = 0; i < tasks.length; i++) {
      ...
      normalizedTasks.push({
        ...
        correct_answer: typeof correctAnswer === "object" ? correctAnswer : String(correctAnswer),
        rubric: t.rubric != null ? (typeof t.rubric === "object" ? t.rubric : String(t.rubric)) : undefined,
